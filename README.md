...
- **Goblin tavern hub & missions** – Entering the tavern unlocks a barkeep dialogue that tracks mission progress, gives intel about trap status or village threat, and hands out rewards that reduce pressure when objectives are met. 【F:src/state/gameState.js†L39-L65】【F:src/systems/barkeepMissions.js†L6-L200】
...
- **Exploration points of interest** – Optional encounters such as shady traders, wandering merchants, cursed shrines, and bog sprites grant buffs, contraband, or intel while tying into detection and threat systems. 【F:src/systems/pointsOfInterest.js†L10-L149】
