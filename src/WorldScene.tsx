...
function terrainHeight(
  ...
  // The rolling hills previously generated by simplex noise made navigation
  // difficult because many scene elements would intersect the terrain. To keep
  // the ground perfectly level we now return a constant height.
  return 0;
}
  ...
  return useMemo(() => {
    ...
    for (const c of clusters) {
      ...
      for (let i = 0; i < count; i++) {
        ...
        const h = terrainHeight(noise, x, y);
        if (h < -4) continue;
